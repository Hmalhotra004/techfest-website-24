export const p1 = `The event is designed to test participant's adaptability, creativity, and analytical skills, as they present their assigned unconventional careers. Following are the details and activities which will be taking place in each round respectively.`;
